...
contract Trading is Owned {
  ...
  function transfer(Token _coins, Token _tokens, address _seller, address _buyer, uint256 _tokensMoved, uint256 _price) onlyOwner returns (bool) {
    require(_tokens.transferFrom(_seller, _buyer, _tokensMoved));
    require(_coins.transferFrom(_buyer, _seller, _price));
